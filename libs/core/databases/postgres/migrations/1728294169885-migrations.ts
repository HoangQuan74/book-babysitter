...
export class Migrations1728294169885 implements MigrationInterface {
    name = 'Migrations1728294169885'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "post_comment" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL, "updated_at" TIMESTAMP NOT NULL, "deletedAt" TIMESTAMP, "post_id" uuid NOT NULL, "user_id" character varying NOT NULL, "content" text NOT NULL, "comment_parent_id" character varying NOT NULL, "comment_root_id" character varying NOT NULL, CONSTRAINT "PK_5a0d63e41c3c55e11319613550c" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "post_comment" ADD CONSTRAINT "FK_36bc7eb15ed86f27d6898f21298" FOREIGN KEY ("post_id") REFERENCES "post"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "post_comment" DROP CONSTRAINT "FK_36bc7eb15ed86f27d6898f21298"`);
